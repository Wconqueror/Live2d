...
//    std::string str = pathname + filename + extname;
//    NSString *path = [NSString stringWithCString:str.c_str() encoding:(NSUTF8StringEncoding)];
//    NSString *castFilePath = [documentPath stringByAppendingPathComponent:path];
