...
/** 注册cell */
- (void)registerNib:(nullable UINib *)nib forCellReuseIdentifier:(NSString *_Nullable)identifier;
- (void)registerClass:(nullable Class)cellClass forCellReuseIdentifier:(NSString *_Nullable)identifier;
/** 获取缓存cell */
- (__kindof GXCardViewCell *_Nullable)dequeueReusableCellWithIdentifier:(NSString *_Nullable)identifier;
/** 获取index对应的cell */
- (nullable __kindof GXCardViewCell *)cellForRowAtIndex:(NSInteger)index;
/** 获取cell对应的index */
- (NSInteger)indexForCell:(GXCardViewCell *_Nullable)cell;
/** 移除最上层cell */
